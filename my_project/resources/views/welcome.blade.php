...
@section('main_content')
    <div class="container">
        ...
        <h2>Задание:</h2>
        Имеются следующие ресурсы:<br>
        Список записей блога: https://jsonplaceholder.typicode.com/posts<br>
        Комментарии к записям: https://jsonplaceholder.typicode.com/comments<br>
        Требуется:<br>
